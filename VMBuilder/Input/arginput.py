...
def getArgs(requiredArgs):
    ...
    if Arguments.Memory in requiredArgs:
        parser.add_argument('--memory', required=True, action='store', default=None, help='Amount of memory to give to the VM')
    ...
    if Arguments.PowerOn in requiredArgs:
        parser.add_argument('--power_on', required=False, action='store_true', default=None, help='Power on the VM when called for')
